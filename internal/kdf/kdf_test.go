...
func TestDeriveMasterKeyRawCredentialIsValidatedAndCopied(t *testing.T) {
	...
	derived, err := DeriveMasterKey(Credential{Kind: SourceRaw, RawKey: raw}, Argon2Params{}, nil)
	if err != nil {
	...
	if _, err := DeriveMasterKey(Credential{Kind: SourceRaw, RawKey: raw[:MasterKeySize-1]}, Argon2Params{}, nil); err == nil {
